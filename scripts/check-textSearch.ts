 ...
 *   npx tsx scripts/check-textSearch.ts
 */
...
import {
  ...
  escapeLikePattern,
  matchesQuery,
} from '../src/lib/textSearch'
import {
  filterPublicComments,
  publicCommentTexts,
  isPublicComment,
  stripPublicPrefix,
} from '../src/lib/publicComments'
import type { ClickUpComment } from '../src/lib/types'
...
function testIndexNeverLeaksInternal() {
...
function testBoundaryBetweenChunks() {
...
function main() {
  ...
  testLikeEscaping()
  testPublicFilter()
  testIndexNeverLeaksInternal()
  testBoundaryBetweenChunks()
  console.log('check-textSearch: OK')
}
