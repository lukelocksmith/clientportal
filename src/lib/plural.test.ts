/**
 * Polska odmiana po liczbie. Przypadki, na ktorych wywracal sie poprzedni kod:
 * "2 uzytkowniki" (zmiana rdzenia) i "22 zgloszen" (wyjatek 12-14).
 *
 *   npm test
 */
import { describe, it } from 'vitest'
import assert from 'node:assert'
import { plural, pluralForm, USERS, REQUESTS, SUBTASKS, HOURS_LOCATIVE } from '@/lib/plural'

describe('plural', () => {
  it('odmiana, wyjatki 12-14 i wartosci brzegowe', () => {
